    ...
    <div class="container-fluid panel">
        ...
        <a href="admin.php"><h3>Dashbaord</h3></a>
            ...
            <div class="trainer-drop">
                ...
                <a href="viewPackage.php">View Trainers</a><br><br>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 form">
                <form name="myForm" action="../PHP Files/AddPackage.php" method="post" enctype="multipart/form-data" onsubmit="return validation();">
