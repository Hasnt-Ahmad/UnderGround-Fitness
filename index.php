...
<body>
    ...
    <?php  require ('./Website/Database/database.php');
            require('./Website/Model/trainer.php'); 
            $t1=new Trainer($conn);
            $array[]=$t1->getTrainer();
            $imglocation="./Images/";
     ?>
  ...
  <div class="container-fluid bg">
    ...
    <div class="collapse navbar-collapse  " id="navbarNavAltMarkup">
      <div class="navbar-nav ms-auto ">
        ...
        <a href="./Website/Services/index.php" class="nav-link text-white" >Services</a>
        <a href="./Website/Results/result.php" class="nav-link text-white" >Result</a>
        <a href="./Website/About Us/index.php" class="nav-link text-white" >Membership</a>
        <a href="./Website/Contact US/index.php" class="nav-link text-white" >Contact Us</a>
      </div>
    </div>
  </div>
</nav>
